...
События митапов: спикеры, программа (сегменты), галереи, регистрации, теги из core.

| Файл | Назначение |
|------|------------|
| `models.py` | События, спикеры, сегменты, галереи, регистрации, связи с тегами |
| `views.py` | ViewSets |
| `serializers.py` | Сериализаторы и вложенные представления |
| `urls.py` | `speakers`, `events`, `segments`, `galleries`, `registrations` |
| `admin.py` | Админка |
